...
export function SiteFooter({ className }: React.HTMLAttributes<HTMLElement>) {
  return (
    <footer className={cn("py-4 border-t border-border/20 bg-background", className)}> {/* Adjusted py to py-4 for a bit less vertical space */}
      <div className="container flex flex-col items-center justify-between gap-2 md:flex-row md:h-12 px-4 sm:px-6 lg:px-8"> {/* Adjusted gap to gap-2 and added padding */}
