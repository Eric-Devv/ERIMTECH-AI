...
export function CallToActionSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full py-8 md:py-10 bg-gradient-to-br from-background to-secondary/30 scroll-animation">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center glassmorphic p-8 md:p-10 rounded-xl shadow-2xl">
