...
export function CallToActionSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full py-8 md:py-12 bg-gradient-to-br from-background to-secondary/30 scroll-animation">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center glassmorphic p-8 md:p-10 lg:p-12 rounded-xl shadow-2xl">
          <Rocket className="h-12 w-12 md:h-16 md:w-16 text-primary animate-pulse" />
